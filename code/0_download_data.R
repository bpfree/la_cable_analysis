...
### Louisiana Wildlife Management Areas and Refuge Boundaries (source: https://www.wlf.louisiana.gov/assets/Conservation/WMAs_Refuges_Conservation_Areas/Files/LDWF_WMA_Boundaries_Shapefile.zip)
wma_texas_data <- "https://www.wlf.louisiana.gov/assets/Conservation/WMAs_Refuges_Conservation_Areas/Files/LDWF_WMA_Boundaries_Shapefile.zip"

## Marine Protected Areas Inventory (source: https://marineprotectedareas.noaa.gov/media/data/NOAA_MPAI_2020_IUCN_gdb.zip)
### Metadata: https://marineprotectedareas.noaa.gov/media/data/NOAA_MPAI_2020_IUCN_metadata.pdf
mpa_inventory <- "https://marineprotectedareas.noaa.gov/media/data/NOAA_MPAI_2020_IUCN_gdb.zip"

## National Marine Sanctuaries Act (source: https://marinecadastre.gov/downloads/data/mc/NationalMarineSanctuariesAct.zip)
### Metadata: https://www.fisheries.noaa.gov/inport/item/52598
nms_act <- "https://marinecadastre.gov/downloads/data/mc/NationalMarineSanctuariesAct.zip"
...
## National Wetlands Inventory (Louisiana) (source: https://www.fws.gov/wetlands/Data/State-Downloads/LA_geodatabase_wetlands.zip)
### Interactive Wetlands Mapper: https://fwsprimary.wim.usgs.gov/wetlands/apps/wetlands-mapper/
### Metadata: https://www.fws.gov/program/national-wetlands-inventory/metadata (xml: https://www.fws.gov/wetlands/Data/metadata/FWS_Wetlands.xml)
nwi_la <- "https://www.fws.gov/wetlands/Data/State-Downloads/LA_geodatabase_wetlands.zip"
